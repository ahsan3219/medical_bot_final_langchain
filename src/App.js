...
import { davinciDetect } from "./detect"; // Import the function to interact with OpenAI
import { booking } from "./appointment";
import { davinci } from "./chatai"; // Import the function to interact with OpenAI
import dr from "./dr"; // Import the avatar image
import { getUserLocation } from "./map";
  ...
  const handleNewUserMessage = async (newMessage) => {
    try {
      ...
      if (
        ...
        // addResponseMessage(botResponse);
      } else if (get.value !== "Book Appointment") {
        console.log("else");
